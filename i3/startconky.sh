# #!/bin/bash
#
# sleep 15 #time (in s) for the DE to start; use ~20 for Gnome or KDE, less for Xfce/LXDE etc
# conky -c /bin/conky_scripts/rings & # the main conky with rings
...
# conky -c /bin/conky_scripts/cpu &
# conky -c /bin/conky_scripts/mem &
# conky -c /bin/conky_scripts/notes &
#
